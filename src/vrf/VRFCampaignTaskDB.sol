...
interface IVRFCampaignTaskDB is IERC165
{
    ...
    /**
     * This method assigns the resulting random seed generated by DVRANDAO, and announces the winner of 
     * the campaign.
...
contract VRFCampaignTaskDB is IVRFCampaignTaskDB, ERC165, DVControllable 
{
    modifier onlyClient() {
        _checkOwner();
        _;
