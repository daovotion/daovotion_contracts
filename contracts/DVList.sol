...
{
    function info(DVTokenList storage listobj) internal returns(DVTokenListInfo memory)
    {
...
{
    function info(DVTokenOwnershipList storage list_container, uint256 parent_token) internal returns(DVTokenListInfo memory)
    {
