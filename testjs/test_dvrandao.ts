...
import {DVRANDAO, DVRANDAO__factory, VRFController,
...
describe("DVRANDAO", function () {
    ...
    it("Test Records Signature", async function () {
        ...
        const DVRFac2 = new DVRANDAO__factory(signer);
        const dvrcontract2 = await DVRFac2.deploy();
        await dvrcontract2.deployed();

        console.log("** Contract DVRANDAO2 deployed with address", dvrcontract2.address);
